...
return {
  ...
  },
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<F13>', ':FloatermToggle<CR>', { desc = 'Toggle Floaterm terminal' })
      vim.keymap.set('t', '<F13>', '<C-\\><C-n>:FloatermToggle<CR>', { desc = 'Toggle Floaterm terminal (from terminal mode)' })

      -- Optional: Additional keybindings
      --vim.keymap.set('n', '<leader>n', ':FloatermNext<CR>', { desc = 'Go to next Floaterm terminal' })
      --vim.keymap.set('n', '<leader>p', ':FloatermPrev<CR>', { desc = 'Go to previous Floaterm terminal' })

      -- Customize Floaterm appearance
